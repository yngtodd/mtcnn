...
def save_model(model, params):
    path = "saved_models/{params['DATASET']}_{params['MODEL']}_{params['EPOCH']}.pkl"
    pickle.dump(model, open(path, "wb"))
    print("A model is saved successfully as {path}!")
...
def load_model(params):
    ...
    try:
        ...
        print("Model in {path} loaded successfully!")

        return model
    except:
        print("No available model such as {path}.")
        exit()
